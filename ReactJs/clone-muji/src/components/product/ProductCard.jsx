...
const ProductCard = ({ productImage, productName, productPrice, isNew }) => {
  return (
    <div className="flex flex-col w-full relative">
      ...
      <div className="h-[50%] px-3 pt-3 pb-5">
        <p className="text-xs font-normal leading-5 text-gray-800 break-words hover:text-[#80001c] hover:cursor-pointer mb-4 md:mb-1">
          {productName}
        </p>
        <div className="flex justify-between mb-2 items-center">
          ...
          <div className="bg-yellow-200 p-1 rounded-full text-xl shadow-sm ">
